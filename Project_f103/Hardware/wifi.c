...
void NRF24L01_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA, ENABLE);//使能GPIOB,G时钟
	
	GPIO_InitStructure.GPIO_Pin = NRF24L01_CE_PIN;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;//普通输出模式
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//50MHz
	GPIO_Init(NRF24L01_CE_GPIO, &GPIO_InitStructure);//初始化CSN
...
/**********************************************************************************************************
*@name: 	NRF24L01_Read_Buf
*@brief: 	在指定位置读出指定长度的数据
*@param: 	<u8> 	reg 	指定寄存器地址
			<u8*> 	pBuf	数据指针
			<u8>	len 	数据长度
*@retval: 	<u8> 返回此次读到的状态寄存器的值
**********************************************************************************************************/
...
/**********************************************************************************************************
*@name: 	NRF24L01_TxPacket
*@brief: 	启动NRF24L01发送一次数据
*@param: 	<u8*> 	txbuff 	待发送数据首地址
*@retval: 	<u8> 	返回发送完成状况
**********************************************************************************************************/
...
/**********************************************************************************************************
*@name: 	NRF24L01_RxPacket
*@brief: 	启动NRF24L01接收一次数据
*@param: 	<u8*> 	rxbuff 	接收数据首地址
*@retval: 	<u8> 	返回接收完成状况
**********************************************************************************************************/
