...
#define MAX_TX      	0x20 // TX_DS bit (data sent TX FIFO interrupt)
#define TX_OK        	0x10 // MAX_RT bit (maximum number of TX re-transmits interrupt)
#define RX_OK			0x40 // RX_DR bit (data ready RX FIFO interrupt)

#define NRF24L01_IRQ         GPIO_ReadInputDataBit(NRF24L01_IRQ_GPIO,NRF24L01_IRQ_PIN)
...
#define	NRF24L01_CE		PAout(3)
#define NRF24L01_CSN	PAout(4)
