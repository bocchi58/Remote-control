...
{	 
		...
		//记得修改GPIO_PinSource
		GPIO_PinAFConfig(NRF24L01_SCK_GPIO,GPIO_PinSource5,GPIO_AF_SPI1); //PA5复用为 SPI1
		GPIO_PinAFConfig(NRF24L01_MISO_GPIO,GPIO_PinSource6,GPIO_AF_SPI1); //PA6复用为 SPI1
		GPIO_PinAFConfig(NRF24L01_MOSI_GPIO,GPIO_PinSource7,GPIO_AF_SPI1); //PA7复用为 SPI1
